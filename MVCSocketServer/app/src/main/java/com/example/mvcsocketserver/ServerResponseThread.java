...
public class ServerResponseThread implements Runnable {
    ...
    private static final String TAG_D = "ServerResponseThread_D";
        ...
        try {
            ...
            if (receiveThread != null) {
                ...
                if (receiveThread.bufferedReader != null) {
                    ...
                    Log.d(TAG_D,"before closeBufferedReader");
                    SocketUtil.closeBufferedReader(receiveThread.bufferedReader);
                    Log.d(TAG_D,"after closeBufferedReader");
                    receiveThread.bufferedReader = null;
                }
                receiveThread = null;
                Log.d(TAG_D,"stop receiveThread");
            }
            ...
            try {
                while (!isCancel) {
                    ...
                    if (msg != null) {
                        ...
                        Log.d(TAG_D,"client is offline...");
                        ServerResponseThread.this.stop();
                        socketServerResponseInterface.clientOffline();
                        break;
                    }
                    // Log.d(TAG_D,"ReceiveThread");
                }

                SocketUtil.inputStreamShutdown(socket);
                SocketUtil.closeBufferedReader(bufferedReader);
                Log.d(TAG_D,"ReceiveThread is finish");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
